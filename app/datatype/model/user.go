...
import (
	"github.com/atpuxiner/gin-layout/app/datatype"
)

type BaseUser struct{}

func (BaseUser) TableName() string {
	return datatype.TblNameUser
}
...
type User struct {
	...
	Age      uint   `gorm:"column:age;type:int;not null;comment:年龄"`
	Gender   uint   `gorm:"column:gender;type:int;not null;comment:性别(1-男，2-女)"`
}
